...
const createPointAddWithoutOffersTemplate = () => `<li class="trip-events__item">
...
export default class PointAddWithoutOffersView {
  getTemplate() {
    return createPointAddWithoutOffersTemplate();
  }
